...
export interface QrResolved {
  ...
  seat_no: number; // 双人票：1 或 2（其余票种固定 1）
}
...
export const performCheckin = (registrationId: number, method: CheckinMethod, operator?: string, seat?: number): Promise<CheckinResult> =>
  post<CheckinResult>(`/registrations/${registrationId}/checkin`, { method, operator, seat });
