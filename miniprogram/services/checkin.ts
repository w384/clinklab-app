...
export const resolveQrToken = (qrToken: string) =>
  get<QrResolved>(`/checkin/resolve?qrToken=${encodeURIComponent(qrToken)}`);

export const searchByPhoneLast4 = (eventId: number, last4: string) =>
...
export const performCheckin = (registrationId: number, method: CheckinMethod, operator?: string) =>
